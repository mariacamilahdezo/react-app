...
export const selectCurrentLanguageId = (state) =>
	state.i18n && state.i18n.language;
export const selectLanguages = (state) => state.i18n && state.i18n.languages;
